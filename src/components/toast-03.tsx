    ...
    <>
      {open && (
        <div className={className} role="alert">
          <div className="inline-flex min-w-[20rem] px-4 py-2 rounded-xs text-sm bg-white dark:bg-slate-800 shadow-lg border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-100">

  ...
  return (
    <Transition appear show={isOpen}>
      <Dialog as="div" onClose={() => setIsOpen(false)}>
        ...
        >
          <DialogPanel className="bg-white dark:bg-slate-800 border border-transparent dark:border-slate-700 overflow-auto max-w-2xl w-full max-h-full rounded-sm shadow-lg">
            {/* Search form */}
            ...
            <div className="py-4 px-2">
              ...
              <div className="mb-3 last:mb-0">
                ...
                <ul className="text-sm">
                  <li>
                    <Link
                      className="flex items-center p-2 text-slate-800 dark:text-slate-100 hover:text-white hover:bg-indigo-500 focus-within:text-white focus-within:bg-indigo-500 outline-hidden rounded-sm group"
                      href="#0"
                    >
                      <svg

    ...
    <Menu as="div" className="relative inline-flex">
      {({ open }) => (
        <>
          ...
          <Transition
            as="div"
            className="z-10 absolute top-full right-0 w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 py-1.5 rounded-sm shadow-lg overflow-hidden mt-1"
            ...
            leaveTo="opacity-0"
          >
            <Menu.Items className="font-medium text-sm text-slate-600 dark:text-slate-300 focus:outline-hidden">

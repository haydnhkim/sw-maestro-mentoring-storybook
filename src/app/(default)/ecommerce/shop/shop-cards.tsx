        ...
        <div className="grow flex flex-col p-5">
          ...
          <div className="grow">
            ...
            <header className="mb-3">
              <h3 className="text-lg text-slate-800 dark:text-slate-100 font-semibold">{title}</h3>
            </header>
            {/* Rating and price */}
            <div className="flex flex-wrap justify-between items-center mb-4">
              ...
              <div className="flex items-center space-x-2 mr-2">
                ...
                {/* Rate */}
                <div className="inline-flex text-sm font-medium text-amber-600">{rate}</div>
              </div>
              {/* Price */}
              <div>
                <div
                  className="inline-flex text-sm font-medium bg-emerald-100 dark:bg-emerald-400/30 text-emerald-600 dark:text-emerald-400 rounded-full text-center px-2 py-0.5">${price}.00
                </div>
              </div>
            </div>
            {/* Features list */}
            <ul className="text-sm space-y-2 mb-5 dark:text-slate-300">
              <li className="flex items-center">
                <svg className="w-4 h-4 fill-current text-slate-400 dark:text-slate-500 shrink-0 mr-3"
                     viewBox="0 0 16 16">
                  <path
